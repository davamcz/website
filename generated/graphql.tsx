...
export type GetTransactionsStatisticsQueryVariables = {};


export type GetTransactionsStatisticsQuery = (
  { __typename?: 'Query' }
...
export const GetTransactionsStatisticsDocument = gql`
...
/**
 * __useGetTransactionsStatisticsQuery__
 *
 * To run a query within a React component, call `useGetTransactionsStatisticsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTransactionsStatisticsQuery` returns an object from Apollo Client that contains loading, error, and data properties 
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTransactionsStatisticsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetTransactionsStatisticsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetTransactionsStatisticsQuery, GetTransactionsStatisticsQueryVariables>) {
        return ApolloReactHooks.useQuery<GetTransactionsStatisticsQuery, GetTransactionsStatisticsQueryVariables>(GetTransactionsStatisticsDocument, baseOptions);
      }
export function useGetTransactionsStatisticsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetTransactionsStatisticsQuery, GetTransactionsStatisticsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetTransactionsStatisticsQuery, GetTransactionsStatisticsQueryVariables>(GetTransactionsStatisticsDocument, baseOptions);
        }
export type GetTransactionsStatisticsQueryHookResult = ReturnType<typeof useGetTransactionsStatisticsQuery>;
export type GetTransactionsStatisticsLazyQueryHookResult = ReturnType<typeof useGetTransactionsStatisticsLazyQuery>;
export type GetTransactionsStatisticsQueryResult = ApolloReactCommon.QueryResult<GetTransactionsStatisticsQuery, GetTransactionsStatisticsQueryVariables>;

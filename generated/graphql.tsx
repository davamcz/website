...
export type OffersQuery = { __typename?: 'Query' } & {
  offers: Array<
    { __typename?: 'Offer' } & Pick<Offer, 'id' | 'name' | 'price'> & {
        beneficator: { __typename?: 'Organization' } & Pick<
          Organization,
          'name'
        >
        gallery: { __typename?: 'Gallery' } & {
          images: Maybe<Array<{ __typename?: 'File' } & Pick<File, 'key'>>>
        }
      }
  >
}
...
export type ChangeActiveStateOfferMutation = { __typename?: 'Mutation' } & {
  changeActiveStateOffer: { __typename?: 'Offer' } & Pick<
    Offer,
    'id' | 'name' | 'active'
  >
}

export type OrganizationDetailFragment = { __typename?: 'Organization' } & Pick<
  Organization,
  'id' | 'name' | 'description' | 'url'
> & { logo: { __typename?: 'File' } & Pick<File, 'key'> }
...
export type OfferQuery = { __typename?: 'Query' } & {
  offer: Maybe<
    { __typename?: 'Offer' } & Pick<
      ...
      | 'active'
    > & {
        user: { __typename?: 'User' } & Pick<User, 'shortName'>
        gallery: { __typename?: 'Gallery' } & {
          images: Maybe<Array<{ __typename?: 'File' } & Pick<File, 'key'>>>
        }
        beneficator: { __typename?: 'Organization' } & Pick<
          Organization,
          'name' | 'apiId' | 'projectId'
        >
      }
  >
}
...
export type UploadFileMutation = { __typename?: 'Mutation' } & {
  uploadFile: { __typename?: 'File' } & Pick<File, 'id' | 'fileName' | 'key'>
}
...
export type GetTransactionStatusQuery = { __typename?: 'Query' } & {
  getTransactionStatus: { __typename?: 'Transaction' } & Pick<
    Transaction,
    'status'
  >
}
...
export function useOffersQuery(
  ...
  return ApolloReactHooks.useQuery<OffersQuery, OffersQueryVariables>(
    OffersDocument,
    baseOptions
  )
}
export function useOffersLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<OffersQuery, OffersQueryVariables>(
    OffersDocument,
    baseOptions
  )
}
...
export type OffersQueryResult = ApolloReactCommon.QueryResult<
  OffersQuery,
  OffersQueryVariables
>
...
export function useRecentTransactionsQuery(
  ...
  return ApolloReactHooks.useQuery<
    RecentTransactionsQuery,
    RecentTransactionsQueryVariables
  >(RecentTransactionsDocument, baseOptions)
}
...
export type RecentTransactionsQueryHookResult = ReturnType<
  typeof useRecentTransactionsQuery
>
export type RecentTransactionsLazyQueryHookResult = ReturnType<
  typeof useRecentTransactionsLazyQuery
>
export type RecentTransactionsQueryResult = ApolloReactCommon.QueryResult<
  RecentTransactionsQuery,
  RecentTransactionsQueryVariables
>
...
`
export type CreateTransactionMutationFn = ApolloReactCommon.MutationFunction<
...
>
export type CreateTransactionMutationResult = ApolloReactCommon.MutationResult<
  CreateTransactionMutation
>
export type CreateTransactionMutationOptions = ApolloReactCommon.BaseMutationOptions<
  CreateTransactionMutation,
  CreateTransactionMutationVariables
>
...
`
export type ChangeActiveStateOfferMutationFn = ApolloReactCommon.MutationFunction<
  ChangeActiveStateOfferMutation,
  ChangeActiveStateOfferMutationVariables
>
 ...
 * });
 */
export function useChangeActiveStateOfferMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ChangeActiveStateOfferMutation,
    ChangeActiveStateOfferMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    ChangeActiveStateOfferMutation,
    ChangeActiveStateOfferMutationVariables
  >(ChangeActiveStateOfferDocument, baseOptions)
}
export type ChangeActiveStateOfferMutationHookResult = ReturnType<
  typeof useChangeActiveStateOfferMutation
>
export type ChangeActiveStateOfferMutationResult = ApolloReactCommon.MutationResult<
  ChangeActiveStateOfferMutation
>
export type ChangeActiveStateOfferMutationOptions = ApolloReactCommon.BaseMutationOptions<
  ChangeActiveStateOfferMutation,
  ChangeActiveStateOfferMutationVariables
>
...
>
export type CreateOfferMutationResult = ApolloReactCommon.MutationResult<
  CreateOfferMutation
>
...
export function useGetTransactionStatusQuery(
  ...
  return ApolloReactHooks.useQuery<
    GetTransactionStatusQuery,
    GetTransactionStatusQueryVariables
  >(GetTransactionStatusDocument, baseOptions)
}
...
>
export type GetTransactionStatusQueryResult = ApolloReactCommon.QueryResult<
  GetTransactionStatusQuery,
  GetTransactionStatusQueryVariables
>
